...
<section class="row" id="styled">
    <div class="col_16 col align_center">
        ...
        <h2 class="no-border">Fa�a o Login abaixo para acessar a �rea restrita</h2>
...
<footer class="row">
	...
	<div class="col_16 col box_shadow"><span class="align_left left">S.G.V. - Vers�o 1.0</span> <span class="right">Todos os direitos reservados</span></div>

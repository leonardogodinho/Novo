	...
	<fieldset id="dadosVaga">
		<legend>Dados da Vaga</legend>
            ...
            <div class="grid-6-12">
                ...
                <input type="text" name="titulo" id="titulo" value="<%=o.getTitulo() %>" class="no-margin" placeholder="Título da Vaga">
            </div>
            <div class="grid-5-12">
                <label class="bold">Área de Atuação</label>
                <input  type="text" list="areaatuacao" name="areaAtuacao" placeholder="Digite ou Selecione a Área na lista" class="no-margin formee-list">

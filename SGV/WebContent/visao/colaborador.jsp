		...
		<fieldset>
			<legend>Dados do Colaborador</legend>
				...
				<div class="grid-2-12">
	            	...
	            	<input type="text" name="cpf" value="<%=c.getCpf() %>"  placeholder="00000000000" pattern="[0-9]{11}" onBlur="ValidarCPF(cadastroColaborador.cpf);" maxlength="11" title="Insira apenas Números" required="required" />
				</div>
				<div class="grid-6-12">
	                <label   for="nome" class="bold">Nome <em class="formee-req">*</em></label>
	                <input type="text" name="nome" value="<%=c.getNome() %>"  placeholder="Nome completo do colaborador" required="required">
				</div>
				<div class="grid-3-12">
			...
			<div class="grid-4-12">
            	...
            	<input type="email" name="email" value="<%=c.getEmail() %>" placeholder="seu@email.com" required="required">
			</div>
			<div class="grid-4-12">
            				<label  for="senha" class="bold">Senha de acesso <em class="formee-req">*</em></label>
            				<input type="text" name="senha" value="<%=c.getSenha() %>"  placeholder="Senha de Acesso" required="required">
			</div>
			<div class="grid-4-12">
